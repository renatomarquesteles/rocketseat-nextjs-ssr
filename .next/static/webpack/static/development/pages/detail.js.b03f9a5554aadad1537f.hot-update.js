...
})(["padding:10px 15px;display:flex;flex-direction:column;h1{padding:5px 0;font-size:40px;border-bottom:1px solid rgba(0,0,0,0.2);}img{margin-top:20px;max-width:200px;}nav{margin-top:40px;text-decoration:underline;}button{font-size:20px;margin-top:10px;}"]);
...
//# sourceMappingURL=detail.js.b03f9a5554aadad1537f.hot-update.js.map