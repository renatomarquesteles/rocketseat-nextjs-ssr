...
function _templateObject() {
  var data = Object(_babel_runtime_corejs2_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_1__["default"])(["\n  padding: 10px 15px;\n  font-size: 20px;\n\n  h1 {\n    margin-bottom: 1px solid rgab(0, 0, 0, 0.2);\n  }\n\n  ul {\n    margin-top: 15px;\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n  }\n"]);
...
var User = function User(_ref) {
  ...
  return __jsx(_src_styles_global__WEBPACK_IMPORTED_MODULE_8__["Container"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("title", null, "Users")), __jsx("img", {
    ...
    href: "/"
  }, __jsx("a", null, "Voltar"))), __jsx("h1", null, "Users"), __jsx("ul", null, users.map(function (user) {
    return __jsx("li", {
      key: user.id
    }, __jsx(next_link__WEBPACK_IMPORTED_MODULE_4___default.a, {
      href: "/users/".concat(user.login)
    }, __jsx("a", null, user.login)));
  }))), __jsx(_src_styles_global__WEBPACK_IMPORTED_MODULE_8__["GlobalStyle"], null));
};
...
//# sourceMappingURL=users.js.22dce4c9b00c5806f145.hot-update.js.map