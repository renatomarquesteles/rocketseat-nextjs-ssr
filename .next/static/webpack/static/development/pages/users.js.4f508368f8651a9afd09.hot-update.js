...
var User = function User(_ref) {
  ...
  return __jsx(_src_styles_global__WEBPACK_IMPORTED_MODULE_7__["Container"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("title", null, "Users")), __jsx("img", {
    src: "/images/glasses.jpg",
    width: "800"
  }), __jsx(Content, null, __jsx("nav", null, __jsx(next_link__WEBPACK_IMPORTED_MODULE_4___default.a, {
    href: "/"
  }, __jsx("a", null, "Voltar"))), __jsx("ul", null, users.map(function (user) {
    return __jsx("li", {
      key: user.id
    }, __jsx(next_link__WEBPACK_IMPORTED_MODULE_4___default.a, {
      href: "/users/".concat(user.login)
    }, __jsx("a", null, user.login)));
  }))), __jsx(_src_styles_global__WEBPACK_IMPORTED_MODULE_7__["GlobalStyle"], null));
};
...
//# sourceMappingURL=users.js.4f508368f8651a9afd09.hot-update.js.map